...
int op_items(int nitems,int tbl,struct XX_INST *xx_inst,uchar *codes)
{
	...
	//printf("===op_items start nitems:[%x]===\n",nitems);
...
int item_type(char *item_type,int nitem,struct XX_INST *xx_inst,uchar *codes)
{
	...
	//printf("===item_type start item_type:[%s] nitem:[%x] item_data_size:[%x]===\n",item_type,nitem,xx_inst->xx_inst_items.xx_inst_items_var[nitem].item_data_size);
	...
	//printf("ltype_id:[%s] item_data_size:[%x]===\n",xx_inst->xx_inst_table.tbl_item_ltype->ltype_uuid,xx_inst->xx_inst_items.xx_inst_items_var[nitem].item_data_size);
