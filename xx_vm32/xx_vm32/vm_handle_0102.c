...
/*
mov wt0,w[regbase+index]
sub sp,2
mov w[sp+00],wt0
*/
int vm_handle_0102(struct XX_INST *xx_inst,int num,struct XX_CONTEXT *xx_contect,char *outs,int outs_size,char *out_var)
{
	int n=0;
	int iret=0;
	int f_cnd=0;
				...
				if(xx_inst[n].xx_inst_items.xx_inst_items_flag[1].item_type==INST_ITEM_TYPE_MREGI)
				{
						...
						xx_inst[n].xx_inst_items.xx_inst_items_var[1].item_data_size==INST_ITEM_SIZE_8)
					{
						...
						{	
							...
							//xx_get_reg(xx_inst[n].xx_inst_items.xx_inst_items_var[1].item_index_def,tmp);
		...
		if(memcmp(xx_inst[n].xx_inst_code.opcode_type,sop_mov,sop_len)==0)
		{
				...
				xx_inst[n].xx_inst_items.xx_inst_items_var[0].item_const[0]==0x00)
			{
				...
				if(xx_inst[n].xx_inst_items.xx_inst_items_flag[1].item_type==INST_ITEM_TYPE_REG &&
					xreg_incmp(xx_inst[n].xx_inst_items.xx_inst_items_var[1].item_reg_def,t0)==0 &&
