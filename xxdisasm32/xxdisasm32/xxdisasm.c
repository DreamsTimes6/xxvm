...
void xx_disasm_mod_dispatch(struct XX_INST* xx_inst,uchar *codes)
{
	...
	//printf("xx_begin_check_mod success\n");
	...
	while(1)
	{
		switch(xx_inst->xx_inst_exist.next_op_flag)
		{
			...
			case INST_NEXTOP_ONE_OPCODE:
				...
				if(iret)
				{
					//printf("xx_one_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			case INST_NEXTOP_TWO_OPCODE:
				...
				if(iret)
				{
					//printf("xx_two_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			case INST_NEXTOP_THREE_OPCODE:
				...
				if(iret)
				{
					//printf("xx_three_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			case INST_NEXTOP_EXT_ONE_OPCODE:
				...
				if(iret)
				{
					//printf("xx_ext_one_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			case INST_NEXTOP_EXT_TWO_OPCODE:
				...
				if(iret)
				{
					//printf("xx_ext_two_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			case INST_NEXTOP_EXT_THREE_OPCODE:
				...
				if(iret)
				{
					//printf("xx_ext_three_opcode_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			...
			case INST_NEXTOP_ITEMS:
				...
				if(iret)
				{
					//printf("xx_items_mod iret:[%x]\n",iret);
					xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
					return;
				}
				break;
			default:
				//printf("next_op_flag default\n");
				xx_inst->xx_inst_exist.finish_flag=INST_FLAG_UNEXIST;
				return;
		}
