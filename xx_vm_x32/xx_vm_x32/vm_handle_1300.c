...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
push dword ptr [sp+00]
add sp,4;lea sp,[sp+4]
popfd
*/

int vm_handle_1300(struct XX_INST *xx_inst,int num,struct XX_CONTEXT *xx_contect,char *outs,int outs_size,char *out_var)
{
	int n=0;
	int iret=0;
	int f_cnd=0;
	...
	*/
	...
	{
		/*检查操作码*/
		if(memcmp(xx_inst[n].xx_inst_code.opcode_type,sop_popfd,sop_len)==0)
		{
			...
			memcpy(item_data.result, &xx_contect[n + 1].eflag, sizeof(xx_contect[n + 1].eflag));
