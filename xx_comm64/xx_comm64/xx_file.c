...
arg4   size
*/
DLL_PUBLIC int xx_read_file(char *filename, char* data, unsigned long long fileoffset, unsigned int size)
{
	int iret = 0;
	FILE *file_stream = 0;
...
DLL_PUBLIC int xx_scover_file(char *file, unsigned char *pdata, unsigned long long begin, unsigned int size)
{
	int iret = 0;
